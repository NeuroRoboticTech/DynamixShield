/*
  ...
  pass in any hardware serial connection. You can use CommanderSS if
  you want to use a software serial connection instead. 
...
{    
  public:
    ...
    // joystick offsets to get them zeroed
    signed char walkVOffset;      
    signed char walkHOffset;      
    signed char lookVOffset;      
    signed char lookHOffset;
